...
# -------------------------------------------------------------------
# CONFIG – set this to your actual screen resolution
# -------------------------------------------------------------------
SCREEN_W = 2560  # you told me this is your macOS window width
SCREEN_H = 1664    # and this is the height

# how long we show each dot before collecting (to let your eyes settle)
PRE_WAIT_SECONDS = 0.8
# how long we actually collect samples for each dot
COLLECT_SECONDS = 2.0
...
def main():
    ...
    # Try to make it full‑screen so it matches your Webots layout area
    try:
    ...
    # 3. Build 9 calibration points for this screen size
